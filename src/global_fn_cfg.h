...
typedef void (*fn_max_pool2d)(void *inp, void *oup,
	cc_int32 x, cc_int32 y, cc_int32 s, cc_dtype dt);

typedef void (*fn_conv2d)(void *inp, void *oup, cc_int32 x, cc_int32 y,
		cc_int32 oup_x, cc_int32 oup_y, cc_int32 sx, cc_int32 sy,
	void *filter, cc_int32 fw, cc_dtype dt);

typedef void (*fn_fully_connected)(void *inp, void *oup,
	void *w, void *b, cc_int32 iw, cc_int32 ow, cc_dtype dt);

typedef void (*fn_batch_norm)(
...
typedef void (*fn_array_add_ew)(void *oup,
	int arrlen, void *a, void *b, int dt);
