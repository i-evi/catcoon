...
ECPU_CONV2D_DECLARATION  (f64);
  ...
  #define ALT_CONV2D_F32_K1S1  sse4_conv2d_f32_k1s1
  #define ALT_CONV2D_F32_K2SX  sse4_conv2d_f32_k2sx
  #define ALT_CONV2D_F32_K3SX  sse4_conv2d_f32_k3sx
#endif
...
ECPU_DOTPROD_DECLARATION  (f64);
    ...
    #define ALT_DOTPROD_F32  sse4_dot_prod_f32
  #endif
#endif
